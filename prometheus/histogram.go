...
type Histogram interface {
	...
	// timestamp, and the provided labels. If the labels are empty, the
	// current exemplar in the relevant bucket is left in place. This method
	// panics if any of the provided labels are invalid. ObserveWithExemplar
...
func newHistogram(desc *Desc, opts HistogramOpts, labelValues ...string) Histogram {
	...
	// for both counts as well es exemplars:
